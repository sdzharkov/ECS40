...
void calcAirportTraffic(const CityList& cities, int index); //removed const
...
int findAirport(const CityList& cities, const char *airport); //removed const
...
//void CityList::cleanCities(CityList *cities) 
void cleanCities(CityList &cities) 
{
  int i = 0;
